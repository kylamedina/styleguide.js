...
StyleGuide.prototype = {
    ...
    convertJade: function(sources) {
        ...
        if(sources){
            return sources.map(function(source) {
                ...
                // Compile a function
                var fn = jade.compile(source.example,jadeOptions);
                // Render the function
    ...
    beautifyHtml: function(sources) {
        ...
        if(sources){
            return sources.map(function(source) {
                ...
                source.example = hljs.highlightAuto(source.example, ['jade']).value;
                return source;
            });
        }
    },
    ...
    render: function(options, callback) {
        ...
        source = this.convertJade(source);
